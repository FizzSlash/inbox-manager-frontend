...
-- Example RLS policy (uncomment if you need brand isolation)
-- CREATE POLICY "processing_queue_brand_isolation" ON processing_queue
--   FOR ALL USING (brand_id = (current_setting('app.current_brand_id'))::uuid);

-- Grant permissions (adjust as needed)
-- GRANT ALL ON processing_queue TO service_role;
-- GRANT SELECT, INSERT, UPDATE ON processing_queue TO authenticated;
