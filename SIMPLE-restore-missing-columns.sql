-- ====================================================================
-- SIMPLE TABLE RESTORATION - Just the missing columns you need
-- ====================================================================
...
-- 2. Create UPGRADE_ATTEMPTS table (for Stripe)
...
-- 3. Add missing columns to RETENTION_HARBOR table (for CRM + leads)
...
-- 4. Clean up duplicates and add unique constraint
WITH duplicates AS (
...
SELECT 'Missing columns restored! ✅' as status;