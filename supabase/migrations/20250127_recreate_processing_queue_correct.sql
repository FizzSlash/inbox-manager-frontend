-- Drop and recreate processing_queue table with correct schema based on actual code usage
DROP TABLE IF EXISTS processing_queue CASCADE;

-- Create processing_queue table with EXACTLY the fields your code uses
...
CREATE INDEX idx_processing_queue_lead_id ON processing_queue(lead_id);
