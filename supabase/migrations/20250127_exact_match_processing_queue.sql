...
-- Drop and recreate processing_queue table to match EXACTLY what your frontend inserts
DROP TABLE IF EXISTS processing_queue CASCADE;

-- Create processing_queue table with ONLY the columns your frontend code uses
